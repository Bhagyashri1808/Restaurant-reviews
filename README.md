...
The **Restaurant Reviews** is a mobile-ready web application. The application is designed to be responsive on different sized displays and accessible for screen reader use. It also provides service worker for a seamless offline experience for users.
